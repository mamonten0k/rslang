...
const CrewMembers = [
  {
    ...
    image: ivanImg,
    description:
      'Разработчик. Отвечал за архитектуру приложения. Настроил модуль авторизации. Создатель главной страницы приложения. Автор игр "Аудиовызов" и "Саванна". Создал краткосрочную статистику.',
  },
  {
    name: 'Вячеслав',
    ...
    image: vyachImg,
    description:
      'Тим-лид проекта. Координировал работу команды. Отвечал за создание электронного учебника, долгосрочной статистики.  Автор игры "Спринт".',
  },
];
